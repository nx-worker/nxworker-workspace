...
async function runBenchmark() {
  ...
  console.log('\n   Results:');
  console.log(
    `   ├─ BEFORE: ${before3Time.toFixed(2)}ms (${before3Result.traversalCount} tree traversals)`,
  );
  console.log(
    `   ├─ AFTER:  ${after3Time.toFixed(2)}ms (${after3Result.traversalCount} tree traversal)`,
  );
  console.log(`   ├─ Files matched: ${before3Result.results.length}`);
  console.log(
    `   ├─ Improvement: ${(((before3Time - after3Time) / before3Time) * 100).toFixed(1)}% faster`,
  );
  console.log(
    `   └─ Speedup: ${(before3Time / after3Time).toFixed(2)}× faster\n`,
  );
  ...
  console.log('\n   Results:');
  console.log(
    `   ├─ BEFORE: ${before10Time.toFixed(2)}ms (${before10Result.traversalCount} tree traversals)`,
  );
  console.log(
    `   ├─ AFTER:  ${after10Time.toFixed(2)}ms (${after10Result.traversalCount} tree traversal)`,
  );
  console.log(`   ├─ Files matched: ${before10Result.results.length}`);
  console.log(
    `   ├─ Improvement: ${(((before10Time - after10Time) / before10Time) * 100).toFixed(1)}% faster`,
  );
  console.log(
    `   └─ Speedup: ${(before10Time / after10Time).toFixed(2)}× faster\n`,
  );
  ...
  console.log(
    `   ├─ 3 patterns:  ${(before3Time / after3Time).toFixed(2)}× faster`,
  );
  console.log(
    `   ├─ 10 patterns: ${(before10Time / after10Time).toFixed(2)}× faster`,
  );
