...
describe('verdaccio-controller utilities', () => {
  ...
  describeIntegration('startRegistry (integration)', () => {
    it(
      'should start the registry and return registry info',
      async () => {
    ...
    it(
      'should reuse existing registry instance',
      async () => {
    ...
    it(
      'should fall back to alternative ports if preferred port is unavailable',
      async () => {
