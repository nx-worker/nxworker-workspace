...
benchmarkSuite('Move file across 10 projects', {
...
benchmarkSuite('Process 100 large files', {
...
benchmarkSuite('Update 50 relative imports', {
...
benchmarkSuite('Large workspace scenario', {
